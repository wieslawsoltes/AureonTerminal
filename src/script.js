...
export const colors={blue:'#578bfa',red:'#ef6470',green:'#25bd9c',orange:'#efb466',purple:'#b698ed',yellow:'#ead074',white:'#ffffff',black:'#101419',aqua:'#61c7ca',teal:'#25bd9c',gray:'#8792a2',lime:'#78cf84',fuchsia:'#e281b4',maroon:'#a44865',silver:'#c0c5ce',navy:'#34558c',olive:'#8b965b'};
export const baseFields={open:'o',high:'h',low:'l',close:'c',volume:'v'};
...
export function technicalSignature(name){
...
export const SCRIPT_EXAMPLES={
  streaming:'indicator("Incremental trend and volatility", overlay=true)\nn=input.int(20, "Length", minval=1, maxval=500)\nfast=ta.ema(close,n)\nslow=ta.sma(close,n*2)\nsigma=ta.stdev(close,n)\nplot(fast,"EMA",color=color.aqua)\nplot(slow,"SMA",color=color.orange)\nplot(fast+2*sigma,"Upper",color=color.gray)\nplot(fast-2*sigma,"Lower",color=color.gray)\nplotshape(ta.crossover(fast,slow),title="Cross",color=color.green)\nalertcondition(ta.crossover(fast,slow),"Trend crossing","Fast EMA crossed above slow SMA")',
