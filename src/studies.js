import {rollingPairs,rollingRegression} from './rolling-statistics.js';
import {createStatisticalStudies} from './studies-statistics.js';
...
export function regression(a,n){return rollingRegression(a,n).fit;}
export function correlation(a,b,n){return rollingPairs(a,b,n).correlation;}
...
Object.assign(STUDIES,createStatisticalStudies());
