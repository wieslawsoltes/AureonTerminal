...
## v3 fixed-provider references

Read-only research retains provider timestamps, units/vintages, entitlement labels and pagination limits. Quotes are not generated by valuation engines. No authenticated external service was exercised during local tests.

- Alpaca option snapshots: https://docs.alpaca.markets/us/reference/optionchain
...
- Alpaca client-ID reconciliation: https://docs.alpaca.markets/us/reference/getorderbyclientorderid
- FRED observations: https://fred.stlouisfed.org/docs/api/fred/series_observations.html
- FRED vintage periods: https://fred.stlouisfed.org/docs/api/fred/realtime_period.html
- SEC API contracts: https://www.sec.gov/search-filings/edgar-application-programming-interfaces
...
These describe provider/specification behavior, not Aureon equivalence, a commercial data licence, delivery assurance or production trading approval. Secrets remain server-side; default live routing is disabled.
